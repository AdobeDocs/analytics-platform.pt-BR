...
| [!UICONTROL Rótulos de contexto] | Opcional. Uma lista suspensa de rótulos definidos pelo sistema que podem ser aplicados a um componente. Esses rótulos podem ser necessários para definir um conjunto de componentes que você pode usar em relatórios de experimentação usando o [painel Experimentação](/help/analysis-workspace/c-panels/experimentation.md) em projetos do Analysis Workspace. Consulte [Integrar ao Journey Optimizer](/help/integrations/ajo.md#data-view) e [Relatórios de metas](/help/integrations/at.md) para mais informações. |
