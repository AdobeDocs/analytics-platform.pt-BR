...
- Use a expiração em credenciais que não expiram para conectar ferramentas de BI ao Conector SQL CJA. Thr [Guia de credenciais](https://experienceleague.adobe.com/docs/experience-platform/query/ui/credentials.html?lang=en) fornece mais informações sobre como definir credenciais que estão expirando ou credenciais que não estão expirando.
...
| Cláusula HAVING | <pre>SELECIONE dim1, SOMA(métrica1) AS m1<br/>DE dv1<br/>ONDE \`timestamp\` ENTRE &#39;2022-01-01&#39; E &#39;2022-01-02&#39;<br/>GRUPO POR dim1<br/>TENDO m1 > 100</pre> |
