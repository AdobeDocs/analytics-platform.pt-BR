...
>title="Typecast"
>abstract="Essa função oferece a capacidade de alterar o tipo de campo dinamicamente para disponibilizar o campo para transformações adicionais no Customer Journey Analytics."

>[!CONTEXTUALHELP]
>id="dataview_derivedfields_depth"
>title="Profundidade"
>abstract="Esta função fornece a capacidade de retornar a profundidade de qualquer campo, semelhante à funcionalidade do componente padrão de profundidade do evento."
