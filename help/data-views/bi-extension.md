...
1. Crie [credenciais sem expiração no Experience Platform](https://experienceleague.adobe.com/pt-br/docs/experience-platform/query/ui/credentials#non-expiring-credentials). Se você quiser usar credenciais sem expiração já existentes, verifique se essas credenciais estão [migradas para OAuth](https://experienceleague.adobe.com/pt-br/docs/experience-platform/query/ui/credentials#migrate-credentials).

1. Verifique se a credencial sem expiração está disponível para os perfis de produto e de produto do Customer Journey Analytics. Você precisa ser administrador do sistema para que a organização execute as etapas a seguir.
   1. Selecione **[!UICONTROL Admin Console]** do ![aplicativo](/help/assets/icons/Apps.svg).
   1. Verifique se a credencial sem expiração foi adicionada à lista de credenciais de API.
      1. Selecione **[!UICONTROL Usuários]** no menu superior.
      1. Selecione **[!UICONTROL Credenciais da API]** no painel esquerdo.
      1. As credenciais novas ou migradas sem expiração devem ser listadas e começar com **[!UICONTROL EQS-...]**.

      1. Verifique se a credencial da API sem expiração tem acesso ao produto e aos perfis do Customer Journey Analytics.

         1. Selecione ![ProductDetails](/help/assets/icons/ProductDetails.svg) para a credencial de API **[!UICONTROL EQS-...]** sem expiração.
         1. No painel de detalhes do produto **[!UICONTROL EQS-...]**, selecione ![Mais](/help/assets/icons/More.svg) e selecione **[!UICONTROL Editar credenciais de API]**.
         1. Na caixa de diálogo **[!UICONTROL Editar credenciais de API]**, valide os **[!UICONTROL Perfis atribuídos]**. Se nenhum produto da Customer Journey Analytics estiver listado:
            1. Selecione ![Adicionar](/help/assets/icons/Add.svg) e selecione **[!UICONTROL Customer Journey Analytics]**.
            1. Selecione um ou mais perfis de produto que contenham os usuários aos quais você deseja fornecer acesso para o Serviço de consulta e a extensão BI.
            1. Selecione **[!UICONTROL Aplicar]**.

1. Confirme se você vê a credencial de API sem expiração no Serviço de consulta da Experience Platform.

   1. Selecione **[!UICONTROL Experience Platform]** do ![aplicativo](/help/assets/icons/Apps.svg).
   1. Selecione **[!UICONTROL Consultas]** no painel esquerdo.
   1. Selecione **[!UICONTROL Credenciais]** no menu superior.
   1. Você deve ver sua credencial de API sem expiração, usando o nome fornecido na etapa 1, na lista **[!UICONTROL Credenciais sem expiração]**.
...
Por padrão, suas visualizações de dados têm um nome de tabela gerado a partir da ID externa padrão da visualização de dados. Por exemplo, a visualização de dados chamada **[!UICONTROL Minha Visualização de Dados da Web]** tem a ID externa `My_web_data_view`. É possível definir um nome preferencial a ser usado na ferramenta do BI para a sua visualização de dados. Consulte [Configurações da visualização de dados](create-dataview.md#settings) para mais informações.
