...
| Ação | Descrição |
|---|---|
| ![AddCircle](/help/assets/icons/AddCircle.svg) **[!UICONTROL Adicionar]** | Adicione outro segmento, usando o [Construtor de segmentos](seg-builder.md). |
