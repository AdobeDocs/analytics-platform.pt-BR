...
| **Usar a [API de anotações do Customer Journey Analytics](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/)** | As APIs de anotações do Customer Journey Analytics permitem criar, atualizar ou recuperar anotações de forma programática por meio do Adobe Developer. Essas APIs usam os mesmos dados e métodos que a Adobe usa na interface do usuário do produto. |

{style="table-layout:auto"}

1. Preencha os elementos do [!UICONTROL Construtor de anotações].

   ![Janela de detalhes da anotação mostrando campos e opções descritos na próxima seção.](assets/ann-builder.png)
