...
![Interface do gerenciador de métricas calculadas](assets/calculated-metrics-manager.png)
...
|:---:|---|---|
| ![AddCircle](/help/assets/icons/AddCircle.svg) | **[!UICONTROL Adicionar]** | Adicione outras métricas calculadas, usando o [Criador de métricas calculadas](cm-build-metrics.md). |
