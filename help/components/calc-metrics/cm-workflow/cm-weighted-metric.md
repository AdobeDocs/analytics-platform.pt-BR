...
![Janela Resumo mostrando as métricas aplicadas à coluna 1 (Visitas) e à coluna 2 (100) juntamente com a Taxa de rejeição. ](assets/cm_fbr.png)
...
![Se e, em seguida, filtre mostrando a Taxa de rejeição para os principais 30% de páginas classificadas por visitas.](assets/cm_wbr_2.png)
