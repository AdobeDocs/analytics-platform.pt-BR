...
Se você estiver migrando do Adobe Analytics, os seguintes recursos são novos nos feeds de dados do Customer Journey Analytics:
...
* **Modelo de dados estruturados**: os feeds são criados e entregues usando dados estruturados em vez de cadeias de caracteres simples.

* **painel de componentes do Analysis Workspace**: selecione dimensões e métricas usando o mesmo painel de componentes do Analysis Workspace, em vez de usar uma lista estática de nomes de variáveis.
