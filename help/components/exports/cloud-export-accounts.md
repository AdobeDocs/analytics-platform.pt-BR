...
1. Copie o conteúdo de [!UICONTROL **URI SAS**] para a área de transferência.

   Você usará esse URI SAS para acessar os dados exportados do Analysis Workspace da Zona de aterrissagem de dados da AEP.
