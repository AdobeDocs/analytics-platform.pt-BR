...
# Configurar locais de exportação na nuvem {#configure-cloud-export-locations}
...
>title="Prefixo"
>abstract="A pasta raiz no container em que você deseja inserir os dados. Especifique um nome de pasta estática e adicione uma barra após o nome para criar a pasta. Por exemplo, `folder_name/`"
...
Antes de poder exportar relatórios de Customer Journey Analytics para um destino na nuvem (do [Analysis Workspace](/help/analysis-workspace/export/export-cloud.md) ou do [Report Builder](/help/report-builder/report-builder-export.md)), você precisa adicionar e configurar o local para onde deseja que os dados sejam enviados. Esse processo consiste em:

1. Adicionar e configurar a conta (como Amazon S3, Google Cloud Platform etc.) conforme descrito em [Configurar contas de exportação na nuvem](/help/components/exports/cloud-export-accounts.md)

1. Adicionar e configurar o local nessa conta (como uma pasta na conta) conforme descrito neste artigo.

Para obter informações sobre como gerenciar locais existentes, incluindo a exibição, edição e exclusão de locais, consulte [Gerenciar locais de exportação na nuvem e contas](/help/components/exports/manage-export-locations.md).

## Começar a criar um local de exportação na nuvem

1. Você precisa adicionar uma conta antes de adicionar um local. Se ainda não o fez, adicione uma conta conforme descrito em [Configurar contas de exportação na nuvem](/help/components/exports/cloud-export-accounts.md).

1. No Customer Journey Analytics, selecione [!UICONTROL **Componentes**] > [!UICONTROL **Exportações**].

1. Selecione a guia [!UICONTROL **Locais**] e, em seguida, selecione [!UICONTROL **Adicionar local**].

   ![Janela de exportações com a guia Local selecionada, destacando o botão Adicionar local](assets/location-add.png)
...
1. Na seção [!UICONTROL **Propriedades do local**] da caixa de diálogo [!UICONTROL **Adicionar local**], especifique as seguintes informações para configurar um local ARN de Função S3 do Amazon:
   ...
   | [!UICONTROL **Prefixo**] | A pasta dentro do bucket onde você deseja inserir os dados. Especifique um nome de pasta estática e adicione uma barra após o nome para criar a pasta. Por exemplo, folder_name/ |
