...
* **Real-Time Customer Data Platform**: a contagem na Real-Time Customer Data Platform é determinística, com base em processos de avaliação diários, e ela é corrigida ao término da publicação do público-alvo no portal.
