...
>abstract="Depois de salvar as modificações na interface Conexões, uma alteração na configuração de identidade exclui os dados de conexão desse conjunto de dados. Será necessário iniciar manualmente um preenchimento retroativo de dados para o conjunto de dados, com base nas novas configurações.<br/><br/>É possível haver um atraso nos relatórios até a conclusão do processo de exclusão."
