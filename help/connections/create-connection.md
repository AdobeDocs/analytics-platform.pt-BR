...
>abstract="Uma alteração da ID de pessoa exclui todos os dados existentes na conexão. Você precisa assimilar novamente os dados do conjunto de dados com base na nova ID de pessoa.<br/><br/>Ao selecionar **[!UICONTROL Continuar]**, será possível atrasar os relatórios até que o processo de exclusão seja concluído."
