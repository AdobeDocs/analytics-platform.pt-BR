...
>abstract="Detecte e use automaticamente um namespace identityMap definido como **[!UICONTROL primary]**, em cada nível de evento."
...
>abstract="Selecione o namespace a ser usado para escolher o identificador no gráfico de identidade."
>additional-url="https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/stitching/overview" text="Visão geral da compilação"
