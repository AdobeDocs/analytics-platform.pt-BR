...
1. Para exibir a conexão, selecione o nome da conexão do Journey Optimizer que deseja usar no Customer Journey Analytics.

1. Ao exibir a conexão do Journey Optimizer, selecione **[!UICONTROL Usar no CJA]**.
