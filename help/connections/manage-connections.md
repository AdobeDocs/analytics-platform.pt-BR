...
>abstract="Para meses anteriores a setembro de 2024, os dados foram coletados no nível do conjunto de dados e são exibidos como *Outros conjuntos de dados* para maior clareza. A partir de setembro de 2024, os dados são coletados em um nível de conjunto de dados granular, e *outros conjuntos de dados* não são mais exibidos."
<!-- markdownlint-enable MD034 -->
