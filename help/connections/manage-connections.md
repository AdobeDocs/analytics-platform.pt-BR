...
| [!UICONTROL Importar novos dados] | Mostra o status da importação de novos dados para conjuntos de dados: <p><span style="color:green">●</span>   **[!UICONTROL _x _Ligado]**para conjuntos de dados configurados para importar novos dados e<p><span style="color:gray">●</span>   **[!UICONTROL _x Desativado_]** para conjuntos de dados não configurados para importar novos dados. |
...
| [!UICONTROL Transformar dados] | Mostra o status de transformação dos conjuntos de dados de pesquisa B2B aplicáveis. Consulte [Transformar conjuntos de dados para pesquisas B2B](transform-datasets-b2b-lookups.md) para obter mais informações.<p><span style="color:green">●</span>   **[!UICONTROL _x _Ligado]**para conjuntos de dados aplicáveis habilitados para transformação, <p><span style="color:gray">●</span>   **[!UICONTROL _x Desativado_]** para conjuntos de dados aplicáveis não ativados para transformação e<p>**[!UICONTROL N/D]** para todos os outros conjuntos de dados, não aplicável para transformação. |
...
| Transformar dados | Mostra o status de transformação dos conjuntos de dados de pesquisa B2B aplicáveis. Consulte [Transformar conjuntos de dados para pesquisas B2B](transform-datasets-b2b-lookups.md) para obter mais informações.<p><span style="color:green">●</span>   **[!UICONTROL _x _Ligado]**para o número de conjuntos de dados habilitados para transformação. |
...
* Um painel exibe o total de linhas assimiladas que incluem todos os dados de eventos em todas as conexões atualizadas a cada 2º dia de um mês. No painel:
   * uma caixa exibe o número de linhas assimiladas do último mês e a alteração em % (indicada por <span style="color:green">▲</span> ou <span style="color:c64545">2010</span>) do mês anterior.
   * um gráfico de linhas exibe a variável <span style="color:53b2ad">◼︎</span> [!UICONTROL Linhas assimiladas mensais].<br/>Para ver um pop-up que exibe o número de linhas assimiladas mensalmente por um mês, passe o mouse sobre qualquer ponto de dados no gráfico de linhas.
...
* Um painel exibe o total de linhas reportáveis que incluem todos os dados de eventos em todas as conexões atualizadas a cada 2 dias de um mês. No painel:
   ...
   * uma caixa exibe o número total de linhas reportáveis do último mês e a alteração em % (indicada por <span style="color:green">▲</span> ou <span style="color:c64545">2010</span>) do mês anterior.
   * um gráfico de linhas exibe a variável <span style="color:53b2ad">◼︎</span> [!UICONTROL Linhas reportáveis mensais].<br/>Para ver um pop-up que exibe o número de linhas reportáveis cumulativas para um mês específico, passe o mouse sobre qualquer ponto de dados no gráfico de linhas.
   * um gráfico de linhas exibe a variável <span style="color:53b2ad">◼︎</span> [!UICONTROL Linhas relatáveis cumulativas].<br/>Para ver um pop-up que exibe o número de linhas mensais reportáveis de um mês, passe o mouse sobre qualquer ponto de dados no gráfico de linhas.
