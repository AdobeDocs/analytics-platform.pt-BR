---
title: Gerenciar Conexões No Customer Journey Analytics
description: Saiba como gerenciar conexões com conjuntos de dados do Experience Platform no Customer Journey Analytics (Customer Journey Analytics).
mini-toc-levels: 3
...
Para aplicar um filtro à lista de conexões, selecione ![Filtro](/help/assets/icons/Filter.svg). Em seguida, selecione entre as seguintes opções de filtro:
...
| **[!UICONTROL Tipo de conexão]** | Filtrar em conexões [!BADGE B2B edition]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B Edition"} com base em **[!UICONTROL pessoa]** ou **[!UICONTROL conta]**. |
...
| **[!UICONTROL Integrações]** | Somente as conexões com integrações selecionadas são exibidas. |
...
>[!MORELIKETHIS]
>
>Tutorial sobre [Exibir, resolver problemas e modificar configurações de conexão](https://experienceleague.adobe.com/pt-br/docs/customer-journey-analytics-learn/tutorials/connections/connections-details-experience-in-cja).Gerenciar o uso do Customer Journey Analytics](/help/technotes/estimate-usage.md)
>
