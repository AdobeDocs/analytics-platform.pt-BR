...
| **[!UICONTROL Tipo de conjunto de dados]** | O [tipo de conjunto de dados](create-connection.md#dataset-types). O tipo pode ser **[!UICONTROL Evento]**, **[!UICONTROL Perfil]**, **[!UICONTROL Pesquisa]**, **[!UICONTROL Resumo]**. Um conjunto de dados adhoc ou baseado em modelo é identificado por **[!UICONTROL (Adhoc)]** ou **[!UICONTROL (Modelo)]**. Por exemplo, **[!UICONTROL Evento (Adhoc)]** ou **[!UICONTROL Pesquisa (Modelo)]**. |
