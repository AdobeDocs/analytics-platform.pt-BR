...
>abstract="A quantidade total de dados armazenados em disco com carimbo de data e hora para o mês atual (em TB), com uma mudança percentual em comparação ao mês anterior."
