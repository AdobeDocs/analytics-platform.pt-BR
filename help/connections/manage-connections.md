...
>abstract="A quantidade média de armazenamento consumida por cada linha de dados assimilados e armazenados no Customer Journey Analytics (em KB) no mês atual, com uma alteração de porcentagem em comparação com o mês anterior."
