...
* Alterne **[!UICONTROL Incluir experiências]** para habilitar ou desabilitar a disponibilidade de componentes de experiência, visualizações e painéis no Analysis Workspace.
