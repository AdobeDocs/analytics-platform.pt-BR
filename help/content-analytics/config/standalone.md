...
description: Guia passo a passo para configurar o Adobe Content Analytics como uma solução independente. Saiba como configurar esquemas, conjuntos de dados, fluxos de dados e relatórios para obter insights abrangentes sobre o desempenho do conteúdo sem uma implementação completa do Customer Journey Analytics.
...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Gerenciar usuários para um perfil de produto](https://experienceleague.adobe.com/pt-br/docs/experience-platform/access-control/ui/users){target="_blank"} para ver um vídeo de demonstração.
