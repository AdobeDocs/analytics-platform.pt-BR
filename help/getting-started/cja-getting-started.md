...
| Tarefa | Detalhes |
| --- | --- |
| **Etapa 1: Se você estiver migrando do Adobe Analytics para o CJA, leia o guia do administrador.** | [Evolução do Adobe Analytics para Customer Journey Analytics](/help/getting-started/aa-to-cja.md) |
