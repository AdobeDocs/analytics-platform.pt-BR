...
| Compilação baseada em gráfico | Até [Compilação baseada em gráfico](https://experienceleague.adobe.com/en/docs/analytics-platform/using/stitching/overview#graph-based-stitching), você pode aproveitar a força do gráfico de identidade no [Serviço de identidade da Adobe Experience Platform](https://experienceleague.adobe.com/en/docs/experience-platform/identity/home) para elevar os conjuntos de dados à sua identidade preferida. |
