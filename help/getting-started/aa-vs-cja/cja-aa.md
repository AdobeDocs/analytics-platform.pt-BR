...
| Relatório de Sessão Nova vs. Repetida | Compatível a partir de 17 de agosto de 2022, [com uma janela de retrospectiva de 13 meses](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=pt-BR#new-repeat). |
