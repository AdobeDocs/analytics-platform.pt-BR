...
| **Acomodação de qualquer tipo de dados** | O Customer Journey Analytics possui a habilidade da Experience Platform de armazenar toda espécie de esquemas de dados e tipos. Com o [Experience Data Model (XDM)](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/home), os dados podem ser representados e organizados uniformemente, para que estejam prontos para combinação e exploração. O Adobe Analytics foca predominantemente em dados de análise móveis e da Web com alguns recursos de [importação de dados](https://experienceleague.adobe.com/pt-br/docs/analytics/import/home). |
| **B2B Edition** | O [Customer Journey Analytics B2B Edition](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition) ajuda as empresas B2B a alinhar suas equipes de marketing, vendas e produtos, fornecendo insights práticos sobre contas que impulsionam o crescimento da receita. Com a conta posicionada no centro do modelo de dados, toda a análise se concentra na jornada da conta. Adicionar uma nova camada de entidades (contas, oportunidades e grupos de compras) sobre eventos baseados em pessoas e eventos baseados em tempo cria uma imagem completa do ciclo de vida de marketing e receita B2B. |
| **Extensão BI** | A [Extensão BI](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-usecases/data-export/bi-extension) permite conectar o Customer Journey Analytics diretamente às ferramentas de visualização BI populares, como o Power BI ou o Tableau. Ao usar essa extensão, é possível fazer com que os relatórios BI correspondam exatamente ao que é exibido no Analysis Workspace e em outras interfaces de relatório do Customer Journey Analytics. Essa extensão oferece uma maneira muito mais fácil de obter relatórios BI para o Customer Journey Analytcs sem a necessidade de recriar relatórios/métricas a partir de dados brutos. |
| **Comentários em projetos do Workspace** | Os comentários permitem compartilhar insights e fazer perguntas no contexto de um [projeto do Analysis Workspace](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-workspace/build-workspace-project/comment-projects). Isso pode simplificar as conversas sobre os dados, mantendo-as dentro do contexto dos dados em questão. |
| **Content Analytics** | O [Content Analytics](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/content-analytics/content-analytics) ajuda profissionais de marketing a entender como o conteúdo afeta os principais indicadores de desempenho definidos por uma empresa. Além dos dados comportamentais, o Content Analytics coleta dados sobre como o conteúdo é consumido e como ele impulsiona o impacto. |
...
| **Data Insights Agent** | O [Data Insights Agent](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai), parte do Assistente de IA no Customer Journey Analytics, é um agente de conversa de IA generativa. Ele usa componentes da sua visualização de dados e dos seus dados reais para responder de forma rápida e eficiente a perguntas centradas em dados ao criar visualizações relevantes no Analysis Workspace. |
...
| **Detecção de bots** | [Suporte completo](https://experienceleague.adobe.com/pt-br/docs/experience-platform/datastreams/bot-detection) |
...
| **eVar de merchandising** | Suporte completo por meio de [dimensões e métricas de vinculação](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-dataviews/component-settings/persistence) |
...
| **Processamento na hora do relatório** | Suporte completo: o Customer Journey Analytics depende exclusivamente do processamento na hora do relatório. |
...
| **Conjuntos de relatórios virtuais** | Suporte completo. As [Visualizações de dados](/help/data-views/create-dataview.md) são o equivalente do Customer Journey Analytics aos conjuntos de relatórios no Adobe Analytics. |
...
| Recurso | Notas |
| --- | --- |
| **Advertising** | Você pode [coletar dados históricos de IDs AMO e IDs EF para uso no Customer Journey Analytics](https://experienceleague.adobe.com/pt-br/docs/advertising/integrations/analytics/planning/rvars-to-evars). |
...
| **Ofuscação de IP** | Para clientes do Customer Journey Analytics que usam o conector de origem do Analytics para preencher dados do Adobe Analytics no Customer Journey Analytics: as configurações de ofuscação de IP são aplicadas no Adobe Analytics através dos seus dados do Customer Journey Analytics. Você pode controlar essas configurações no Adobe Analytics, conforme necessário.<p>Para clientes do Customer Journey Analytics que usam o SDK da Web da Experience Platform para preencher dados na Platform e no Customer Journey Analytics diretamente. Você pode usar o preparo de dados para coletar dados na Platform e configurar regras que ofuscam o endereço IP com base nos requisitos da sua empresa. |
