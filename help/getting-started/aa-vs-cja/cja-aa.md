...
| **Comentários em projetos do Workspace** | Os comentários permitem compartilhar insights e fazer perguntas no contexto de um [projeto do Analysis Workspace](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-workspace/build-workspace-project/comment-projects?lang=en). Isso pode simplificar as discussões sobre os dados, mantendo conversas no contexto dos dados que estão sendo discutidos. |
