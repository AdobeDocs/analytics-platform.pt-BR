...
| Publicação de público-alvo | Suporte completo. Publicação de segmentos chamada (envio de segmentos do Espaço de trabalho para a Experience Cloud) no AA. A [Publicação de público-alvo](/help/components/audiences/audiences-overview.md) envia públicos-alvo para o Perfil do cliente em tempo real na Experience Platform. |
...
| Análise de mídia de transmissão | Os dados de mídia estarão disponíveis no espaço de trabalho em 30 de julho de 2022, como parte do painel Visualizador simultâneo de mídia e do painel Tempo gasto com a reprodução da mídia. |
...
| Recurso | Notas |
| --- | --- |
| A4T | O suporte é fornecido por meio de campos no [ Analytics Source Connector](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=pt-BR). |
...
| Relatório de Sessão Nova vs. Repetida | Suportado [com uma janela de retrospectiva de 13 meses](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=pt-BR#new-repeat). |
