...
Para configurar e habilitar o recurso *Mapeamento de dados entre IMS*, você deve solicitar o mapeamento por meio do gerente de conta da Adobe. Para fazer isso:
...
As seguintes limitações se aplicam ao recurso *Mapeamento de dados entre IMS*:
...
Considere os seguintes tópicos antes de solicitar o recurso *Mapeamento de dados entre IMS*:
