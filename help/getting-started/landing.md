...
A página de aterrissagem para destaques do Customer Journey Analytics [!DNL Analysis Workspace] O e apresenta uma página inicial do gerente de projeto e uma seção de aprendizado para ajudá-lo a gerenciar os dados de jornada do cliente com mais eficiência.
