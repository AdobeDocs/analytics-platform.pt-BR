...
Use as seguintes seções para determinar qual método de migração Customer Journey Analytics se alinha melhor à implementação atual e às metas futuras de sua organização:
...
|---------|----------|---------|
| **Nova implementação do SDK da Web**</br> Você pode fazer uma nova implementação do SDK da Web da Adobe Experience Platform para começar a enviar dados para o Edge Network da Adobe Experience Platform <!-- what is the correct branding -->. <p>Para organizações que ainda não estão no SDK da Web, esse método de migração talvez seja o mais simples de obter dados para o Edge Network (exigindo o menor número de etapas), mas todo o trabalho é feito antecipadamente, como a criação do esquema XDM.</p><p>As etapas básicas são:</p><ol><li>Criar um esquema XDM para sua organização</li><li>Implementar o SDK da Web</li><li>Enviar dados para a Platform</li></ol> | Alta | Alta |
...
| **Configurar a implementação existente do Adobe Analytics Web SDK para enviar dados ao Customer Journey Analytics**</br> Se sua implementação do Adobe Analytics já estiver usando o SDK da Web, você poderá começar a enviar dados para o Customer Journey Analytics.<p>Antes de enviar dados para o Customer Journey Analytics, considere atualizar seu esquema do Adobe Analytics para as necessidades específicas de sua organização e quaisquer outros aplicativos da plataforma que você usará.</p><p>As etapas básicas são:</p><ol><li>Começar a enviar dados para o Customer Journey Analytics.<!-- What's involved here? Just point it at CJA? --></li><li>(Opcional) Crie um esquema XDM para sua organização à medida que tiver tempo.</li><li>Use o Mapeamento de fluxo de dados para mapear todos os campos no objeto de dados para o esquema XDM.</li></ol> | Baixa | Alta |
...
Use o diagrama a seguir para ajudar a visualizar onde cada método de migração se enquadra no espectro em termos de nível de esforço, bem como a viabilidade a longo prazo que cada um atinge:
...
Use as informações abaixo como diretrizes gerais para entender qual método de migração é mais apropriado para sua organização.
...
### Extensão do AppMeasurement e Adobe Analytics
