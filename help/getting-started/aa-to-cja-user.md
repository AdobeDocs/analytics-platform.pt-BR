...
Se sua organização estiver começando a usar o Customer Journey Analytics, você pode notar algumas semelhanças e diferenças entre o Analytics tradicional e o CJA. Esta página tem como objetivo explicar essas diferenças para ajudar a adaptar sua organização à nova implementação e fluxo de trabalho de relatórios. Esta página também fornece recursos adicionais sobre novos conceitos e outras etapas para tornar sua jornada como um analista mais fácil e bem-sucedida.
...
* [Report Builder](/help/report-builder/report-buider-overview.md) O tem uma nova interface e é executada no PC, no Mac e na versão da Web do Excel.

## Alterações nos relatórios

Você tem acesso a muito mais dados entre canais para analisar. Por exemplo, você pode criar um projeto de espaço de trabalho que analise o desempenho de vários canais
...
[!UICONTROL eVars], [!UICONTROL props]e [!UICONTROL events] no Adobe Analytics tradicional, não existe mais em [!UICONTROL Customer Journey Analytics]. Elementos de esquema ilimitados estão disponíveis, incluindo dimensões, métricas e campos de lista. Todas as configurações de atribuição aplicadas anteriormente durante o processo de coleta de dados agora se aplicam no momento da consulta.
...
[!UICONTROL Customer Journey Analytics] O não usa mais eVars, props ou eventos e, em vez disso, usa qualquer elemento de esquema da plataforma. Essa alteração significa que nenhum dos segmentos existentes é compatível com o [!UICONTROL Customer Journey Analytics]. Se você deseja mover segmentos Adobe Analytics existentes para o Customer Journey Analytics, assista ao vídeo a seguir:
...
As métricas calculadas são nomeadas de forma semelhante entre o Analytics tradicional e o CJA. No entanto, [!UICONTROL Customer Journey Analytics] O não usa mais eVars, props ou eventos e, em vez disso, usa qualquer elemento de esquema da plataforma. Essa mudança fundamental significa que nenhuma das métricas calculadas existentes é compatível com o [!UICONTROL Customer Journey Analytics]. Se você deseja mover as métricas calculadas do Adobe Analytics para o Customer Journey Analytics, assista ao vídeo a seguir:
...
## Alterações no conceito de Classificações
...
## Alterações no conceito do item de dimensão Tráfego baixo

No Analytics tradicional, uma variável que recebe muitos valores únicos inicia a divisão de itens de dimensão em `Low-Traffic`. Customer Journey Analytics tem muitas limitações para campos de alta cardinalidade. As alterações na arquitetura de relatórios permitem que o Analysis Workspace relate muitos itens de dimensão exclusivos. Consulte [Cauda longa](../analysis-workspace/workspace-faq/long-tail.md) para obter mais informações sobre como o CJA otimiza os relatórios para dimensões com muitos valores únicos.
