...
1. Agora, configure os conjuntos de dados um por um.
   ...
   | **[!UICONTROL Chave correspondente]** | Disponível somente para conjuntos de dados de pesquisa. A chave correspondente para entrar em um dos conjuntos de dados de evento. Se esta lista estiver vazia, você provavelmente não adicionou nem configurou um conjunto de dados de evento. |
