...
Se você vem especificamente do Google Analytics 4, consulte [Transição do Google Analytics 4 para o Customer Journey Analytics](../ga-to-cja/home.md) para obter orientação focada em analistas sobre equivalentes de relatórios, diferenças de modelos de dados e comparações de métricas.
