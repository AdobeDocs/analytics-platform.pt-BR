...
| Criação de variáveis para &quot;pré-resolver&quot; relatórios | Projete seu esquema para capturar fatos e usar visualizações de dados para resolver semânticas de relatórios |

## Estabelecer um esquema usando atributos comuns
...
>[!TIP]
>
>Ao decidir se algo deve ser um campo dedicado no esquema em vez de um campo derivado posteriormente, prefira capturar o fato durável no esquema se ele for amplamente útil e estável. Você pode usar campos derivados para corrigir ou remodelar dados após a coleção.
