---
title: Configurar a implementação existente do SDK da web do Adobe Analytics para enviar dados à plataforma.
...
>title="Remover o Adobe Analytics as a service da sequência de dados"
>abstract="Com os dados do SDK da web totalmente funcionais, trabalhe com o admin da Platform para remover o Adobe Analytics as a service da sequência de dados. Antes de fazer isso, verifique se os usuários fizeram a transição do Adobe Analytics para o Customer Journey Analytics."

<!-- markdownlint-enable MD034 -->

{{upgrade-note}}

Se sua implementação do Adobe Analytics já estiver usando o Adobe Experience Platform Web SDK, você poderá começar a enviar dados para a Platform configurando um fluxo de dados. Ou, se já estiver enviando dados para a Platform, basta criar uma conexão entre os conjuntos de dados da Platform e o Customer Journey Analytics.
