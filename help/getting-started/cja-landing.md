...
description: Página de destino do Customer Journey Analytics.
...
>[!TAB Analisar painéis]

Agora você pode detalhar um painel no Analysis Workspace. Há cenários em que um detalhamento de dados e visualizações em um painel é preferível, acima da aplicação de segmentos a um painel.

[![imagem](assets/learn-more-button.svg)](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)

>[!TAB Várias colunas de dimensão]
...
[![imagem](assets/learn-more-button.svg)](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)

>[!TAB Costura em Conexões]

Agora você pode configurar e ativar a compilação em conjuntos de dados de eventos diretamente na interface das conexões do Customer Journey Analytics.

[![imagem](assets/learn-more-button.svg)](/help/stitching/use-stitching-ui.md)

*Você deve ter pelo menos o pacote Select para habilitar a compilação.*


>[!TAB Análise de público-alvo]

A análise de público-alvo permite assimilar dados de associação de público-alvo de conjuntos de dados de perfil da Experience Platform em uma conexão do Customer Journey Analytics.

[![imagem](assets/learn-more-button.svg)](/help/connections/audience-analysis/analyze-audiences.md)
...
*Você precisa ter o pacote Ultimate para usar os relatórios em tempo real.*
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Assimilar e usar dados</strong><br/>Saiba mais sobre as opções que você tem para assimilar dados na Experience Platform e usá-los para análise e relatórios.</div>
    </td>
    <td>
    <a href="/help/guided-analysis/overview.md"><img src="./assets/product-analytics.png"></a>
    <div><strong>Análise guiada</strong><br/>Saiba como usar fluxos de trabalho para obter dados e insights sobre a experiência de produto do cliente. Product Analytics por meio de análise guiada.
    </div>
    </td>
    <td>
    ...
    <div><strong>Content Analytics</strong><br/>Entenda como o conteúdo, ao lado do comportamento, afeta os indicadores-chave de desempenho. Obtenha insights mais profundos sobre os dados de jornada do cliente.</div>
    </td>
  </tr>
  <tr style="border: 0;">
...
<table style="table-layout:fixed">
  ...
  <tr style="border: 0;">
    ...
    <td>
      ...
      <strong>E muito mais...</strong><br/><a href="/help/guided-analysis/overview.md">Análise Guiada</a> - <a href="/help/content-analytics/content-analytics.md">Content Analytics</a> - <a href="/help/getting-started/cja-b2b-edition.md">B2B edition</a> 
    </td>
  </tr>
</table>
