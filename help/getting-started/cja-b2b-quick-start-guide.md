...
O documento [Caso de uso B2B](../data-ingestion/data-ingestion.md) fornece um exemplo de caso de uso sobre como implementar o Customer Journey Analytics B2B edition.
