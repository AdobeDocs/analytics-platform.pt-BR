---
title: Espelhar e usar dados relacionais
description: Explicar como espelhar e usar dados relacionais no Customer Journey Analytics
...
# Espelhar e usar dados relacionais

{{release-limited-testing}}

Este guia de início rápido explica como usar o [Experience Platform Data Mirror for Customer Journey Analytics](data-mirror.md) para espelhar dados relacionais de uma solução nativa de data warehouse no Adobe Experience Platform. E então usar aqueles dados no Customer Journey Analytics.
...
* **Configurar uma conexão** no Customer Journey Analytics. Essa conexão deve (pelo menos) incluir seu conjunto de dados relacional do Experience Platform.
...
O Experience Platform Data Mirror para Customer Journey Analytics requer esquemas relacionais.



>[!NOTE]
>
>Este guia de início rápido é um guia simplificado sobre como espelhar dados relacionais no Adobe Experience Platform e usar esses dados no Customer Journey Analytics. É altamente recomendável estudar as informações adicionais quando referidas.
...
Para espelhar dados no Experience Platform, primeiro defina o esquema para os dados. Todos os dados que você deseja espelhar no Experience Platform e que usam o Experience Platform Data Mirror para Customer Journey Analytics devem estar em conformidade com um esquema relacional.
...
1. Na interface **[!UICONTROL Esquemas]** > **[!UICONTROL Criar esquema relacional]**:
   1. Insira um **[!UICONTROL nome para exibição do esquema]**. Por exemplo: `Sample Event Feed Schema`.
   1. Insira uma **[!UICONTROL Descrição]**. Por exemplo: `Sample event feed schema for a relational schema`.
   1. Selecione **[!UICONTROL Série temporal]** como o **[!UICONTROL Comportamento do esquema]**. Você seleciona **[!UICONTROL Série temporal]** para dados baseados em série temporal e **[!UICONTROL Registro]** para dados baseados em registro. O comportamento define a estrutura do schema e as propriedades incluídas.
      ...
      ![Configuração de esquema](assets/relational-create-schema.png)

   1. Selecione **[!UICONTROL Concluir]**.

1. Na interface **[!UICONTROL Esquemas]** > **[!UICONTROL Esquema de feed de eventos de amostra]**, você verá um aviso de que os esquemas relacionais oferecem suporte à assimilação como linhas de alteração.
...
1. Selecione o esquema relacional criado anteriormente no menu suspenso **[!UICONTROL Esquema]**. Por exemplo: **[!UICONTROL Exemplo de esquema de feed de eventos]**.
...
1. Selecione **[!UICONTROL Adicionar conjuntos de dados]**.
   ...
   1. Na etapa **[!UICONTROL Selecionar conjuntos de dados]** de **[!UICONTROL Adicionar conjuntos de dados]**:
      ...
      1. Selecione o conjunto de dados que contém os dados espelhados. Por exemplo: **[!UICONTROL event-data-mirror]**. O conjunto de dados tem **[!UICONTROL Relational]** como o **[!UICONTROL tipo de conjunto de dados]**.
   ...
   1. Na etapa **[!UICONTROL Configurações do conjunto de dados]** de **[!UICONTROL Adicionar conjuntos de dados]**:
      ...
      Para o conjunto de dados relacional **[!UICONTROL event-data-mirror]**
...
4. Na etapa **[!UICONTROL Componentes]**:
   ...
   1. Adicione qualquer campo de esquema e/ou componente padrão que você deseja incluir nas caixas de componentes **[!UICONTROL MÉTRICAS]** ou **[!UICONTROL DIMENSÕES]**. Adicione campos relevantes do conjunto de dados que contém os dados espelhados. Para acessar esses campos:
      ...
      1. Arraste e solte campos dos esquemas relacionais para **[!UICONTROL METRICS]** ou **[!UICONTROL DIMENSIONS]**.

         ![Adicionar campos relacionais como componentes](assets/cja-add-dataset-folder-dv.png)
   ...
   1. Defina campos derivados para campos que não têm o tipo adequado, não estão no formato adequado ou você deseja modificar por outros motivos. Por exemplo, para **[!UICONTROL Valor de receita]**.
      ...
      1. Arraste o novo campo derivado **[!UICONTROL Valor de receita (Numérico)]** e solte o campo em **[!UICONTROL MÉTRICAS]**.
         ...
         ![CJA - Visualização de dados - Campos relacionais](assets/cja-add-dataset-folder-dv.png)
