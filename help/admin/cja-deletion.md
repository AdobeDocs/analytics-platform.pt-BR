...
| Excluir um conjunto de dados no [!UICONTROL Customer Journey Analytics] | Ao excluir um conjunto de dados de uma conexão no CJA, as exibições de dados e os projetos que dependiam desse conjunto de dados não funcionarão mais. |
