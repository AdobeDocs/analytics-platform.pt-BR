...
A exibição ![Tendências de Conversão](/help/assets/icons/ConversionTrends.svg) **[!UICONTROL Tendências de conversão]** fornece uma visualização com tendência das taxas de conversão ao longo do tempo. O eixo horizontal é um intervalo de tempo, enquanto o eixo vertical representa a taxa de conversão.
...
* **Rastrear esforços de otimização**: depois de identificar os principais gargalos que você deseja melhorar usando a [Fricção](funnel.md), você pode usar esta exibição para rastrear como essas otimizações afetam a taxa de conversão ao longo do tempo.
...
* **[!UICONTROL Modo de Exibição]**: Alternar entre este tipo de modo de exibição e [Atrito](funnel.md).
...
>[!NOTE]
>
>A coluna **Average** na tabela de exibição Tendências de conversão é diferente da coluna **Total** na tabela [Exibição de atrito](funnel.md). A primeira é uma média das colunas de intervalo (por exemplo, média das taxas de conversão diárias), enquanto a última é um cálculo agregado no intervalo de datas completo.
