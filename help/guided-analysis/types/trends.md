...
# Exibição de [!UICONTROL tendências]

A exibição ![GraphTrend](/help/assets/icons/GraphTrend.svg) **[!UICONTROL Trends]** fornece informações valiosas sobre o desempenho do seu produto ou o comportamento dos seus usuários ao longo do tempo. O eixo horizontal desse relatório é um intervalo de tempo, enquanto o eixo vertical mede os eventos desejados.
