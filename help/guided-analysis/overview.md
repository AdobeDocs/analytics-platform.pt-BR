...
1. Clique no ícone de adição ao lado de **[!UICONTROL Acesso à análise guiada]** na lista de [!UICONTROL Itens de permissão disponíveis], o que adiciona o item à lista de [!UICONTROL Itens de permissão incluídos].
