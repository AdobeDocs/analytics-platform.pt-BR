...
>[!NOTE]
>
>Consulte as [Perguntas frequentes](faq.md) para saber a diferença na terminologia (segmentos, filtros e muito mais) entre a Análise guiada e a Analysis Workspace.
...
A interface da análise guiada segue um formato de perguntas e respostas. Formule sua pergunta no painel de consulta e obtenha uma resposta por meio de um insight escrito, gráfico ou tabela. Em seguida, você pode fazer a próxima pergunta com análises e configurações de visualização.
