...
Semelhante aos cartões de pontuação do Analysis Workspace e Mobile, a análise guiada usa dados de um [Visualização de dados](../data-views/data-views.md), que faz referência aos dados no Adobe Experience Platform por meio de uma [Conexão](../connections/overview.md). Muitos relatórios criados na análise guiada podem ser transferidos facilmente para o Analysis Workspace para pesquisas adicionais.
...
1. Clique em **[!UICONTROL Análise guiada]** na página inicial, que leva você diretamente para a página [Exibição de tendências de uso](types/usage.md).
   ...
   ![Mosaico da página de aterrissagem](assets/landing-page-tile.png){style="border:1px solid gray"}
...
Depois que sua organização for provisionada para usar análise guiada, os administradores de perfil de produto poderão adicionar ou remover acesso a ela na Adobe Admin Console.
