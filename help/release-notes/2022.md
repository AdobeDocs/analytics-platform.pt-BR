...
| **Compatibilidade com campo de data no CJA** | Permite que o CJA relate os campos de data e data e hora. [Saiba mais](/help/use-cases/data-views/data-views-usecases.md) | 5 de outubro de 2022 |
