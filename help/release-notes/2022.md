...
| --- | --- | --- |
| **Página de destino padrão** | 5 de janeiro de 2023 | O [nova landing page](/help/getting-started/landing.md) que foi introduzido anteriormente em 2022 se tornará a experiência padrão para todos os usuários no **11 de janeiro de 2023**. A página atual será descontinuada e todos precisarão usar a nova experiência. |
