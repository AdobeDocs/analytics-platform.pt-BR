...
description: Visualizar notas de versão do Customer Journey Analytics de 2023
...
| Recurso | Descrição | [Início da implantação](/help/release-notes/releases.md) | [Disponibilidade geral](/help/release-notes/releases.md) |
| ----------- | ---------- | ----- | --- |
| Dicionário de dados no Analysis Workspace | O Dicionário de dados ajuda os usuários e administradores a rastrear e entender melhor os componentes (dimensões, métricas) em seu ambiente de Customer Journey Analytics. Saiba mais | 8 de março de 2023 | Temporariamente indisponível |
...
| Compartilhamento de link para projetos (sem logon necessário) - Acesso somente para Private beta | Agora é possível compartilhar links somente leitura para projetos Analysis Workspace com pessoas que não têm acesso ao Customer Journey Analytics. Você pode compartilhar links de projeto com pessoas de fora da organização ou aquelas dentro da organização que não estão provisionadas para o Customer Journey Analytics. Saiba mais para participar do Private Beta. Entre em contato com a equipe de contas da Adobe. | 26 de abril de 2023 | Junho de 2023 |
...
| Recurso | Descrição | [Início da implantação](/help/release-notes/releases.md) | [Disponibilidade geral](/help/release-notes/releases.md) |
| ----------- | ---------- | ----- | --- |
| **Compatibilidade de array de objetos com conjuntos de dados de perfil e pesquisa** | Os conjuntos de dados de perfil e de pesquisa agora oferecem suporte a matrizes de objetos para uso no Customer Journey Analytics. | 11 de janeiro de 2023 | 19 de janeiro de 2023 |
