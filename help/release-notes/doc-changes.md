...
| --- | --- |
| **Junho de 2023** | |
| Acesso do Power BI e do Tableau às visualizações de dados do CJA | O Conector SQL do Customer Journey Analytics (CJA) permite acesso SQL a visualizações de dados definidas no CJA. [Saiba mais](/help/data-views/sql-connector.md) |
| Visualizações de dados do Adobe Journey Optimizer | Os administradores do CJA têm acesso a algumas visualizações de dados adicionais no CJA, chamadas “Visualização de dados do AJO (nome da sandbox)”. [Saiba mais](https://experienceleague.adobe.com/docs/journey-optimizer/using/campaigns/content-experiment/reporting-configuration.html?lang=pt-BR). |
...
| Atualizações de métricas calculadas | As seguintes atualizações foram feitas na documentação das métricas calculadas para alinhá-la à funcionalidade atual do CJA: <ul><li>Atualização da lista de [métricas calculadas padrão](/help/components/calc-metrics/default-calcmetrics.md) disponível no CJA</li><li>Atualização dos procedimentos e capturas de tela em vários artigos de métricas calculadas </li></ul> |
| **Maio de 2023** | |
...
| Compatibilidade de recursos atualizada | [Compatibilidade de recursos do Customer Journey Analytics](/help/getting-started/aa-vs-cja/cja-aa.md) atualizada com uma tabela de recursos disponíveis no CJA, mas não disponíveis ou compatíveis com o AA. |
...
| --- | --- |
| **Dezembro de 2022** |  |
| 16 de dezembro de 2022 | Novo tópico sobre [medir e gerenciar o uso de dados do CJA](/help/admin/estimate-usage.md). |
| **Outubro de 2022** | |
...
| Agosto de 2022 | Artigo atualizado significativamente sobre [Controle de acesso do CJA](/help/admin/cja-access-control.md). |
...
| Maio de 2022 | Novo artigo sobre [Ingestão de públicos-alvo da Adobe Experience Platform no CJA](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **Abril de 2022** | |
