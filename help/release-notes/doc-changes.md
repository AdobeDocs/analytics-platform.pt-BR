...
| Assistente de IA | Adicionada [documentação](../ai-assistant.md) no Assistente de IA para o Customer Journey Analytics. |
| Transformar conjuntos de dados para pesquisas B2B | Adição de documentação sobre como oferecer suporte a [pesquisas com base em pessoas em dados B2B](/help/connections//transform-datasets-b2b-lookups.md) (incluindo contas, oportunidades, listas de marketing e campanhas) usando a transformação de conjuntos de dados de pesquisa B2B. |
| Funções de campo derivadas e modelos de função | Adição de documentação sobre as funções de campo derivadas adicionais ([Matemática](/help/data-views/derived-fields/derived-fields.md#math), [Próxima ou Anterior](/help/data-views/derived-fields/derived-fields.md#next-or-previous) e [Resumir](/help/data-views/derived-fields/derived-fields.md#summarize)) e [modelos de função](/help/data-views/derived-fields/derived-fields.md#function-templates). |
| **Maio de 2024** | |
| Integração do Target | Adição do [artigo à seção de integração do Adobe](/help/integrations/at.md) sobre como integrar o Target ao Customer Journey Analytics. |
| Informações necessárias ao exportar relatórios de Customer Journey Analytics para a Google Cloud Platform enquanto usa restrições de política da organização | Adição da ID de organização da Google Cloud Platform de propriedade do Adobe à documentação [Configurar locais de exportação da nuvem](/help/components/exports/cloud-export-locations.md) para exportar relatórios de Customer Journey Analytics para a Google Cloud Platform. <p>Essas informações são necessárias somente para organizações que estejam usando as [Restrições de política da organização](https://cloud.google.com/storage/docs/org-policy-constraints) na Google Cloud Platform.</p> |
...
| Casos de uso da exportação de dados | Conjunto de novos artigos que descreve [casos de uso de exportação de dados](/help/use-cases/data-export/overview.md) e como usar as funcionalidades de Experience Platform e Customer Journey Analytics para implementar esses casos de uso |
...
| Atualização da documentação sobre intervalos de datas personalizados | Atualização de capturas de tela e procedimentos relacionados a [intervalos de datas de exemplo](/help/components/date-ranges/custom-date-ranges.md) para corresponder aos recursos e ao design atuais do produto. |
...
| **Abril de 2024** | |
| Previsão de técnicas estatísticas | Adição de artigo descrevendo as [técnicas estatísticas usadas no serviço de previsão](../analysis-workspace/c-forecast/statistics-forecasting.md). |
...
| Adição de documentação sobre o aprimoramento de permissões para componentes Workspace somente de projeto | Se você compartilhar um projeto com outros usuários, esses usuários poderão editar [filtros rápidos](/help/components/filters/quick-filters.md) e outros componentes somente de projeto incorporados ao projeto compartilhado. |
| **Fevereiro de 2024** | |
...
| Adição de requisitos de permissão para fazer upload de arquivos no Azure SAS e no Azure RBAC ao configurar locais de exportação na nuvem | Adicionados requisitos de permissão exatos para carregar arquivos no Azure SAS e Azure RBAC ao [configurar contas de exportação na nuvem](/help/components/exports/cloud-export-accounts.md) e [configurar locais de exportação na nuvem](/help/components/exports/cloud-export-locations.md). |
| Adição de requisitos de permissão para fazer upload de arquivos em buckets ARN e GCP de função do Amazon S3 ao configurar locais de exportação na nuvem | Adicionados requisitos de permissão exatos para carregar arquivos para os buckets do Amazon S3 Role ARN e da Google Cloud Platform ao [configurar locais de exportação da nuvem](/help/components/exports/cloud-export-locations.md). |
| Esclarecimento de que os administradores de produtos sempre têm acesso às tabelas completas de exportação | As seguintes alterações foram feitas para esclarecer que os usuários com a função de Administrador de produto atribuída têm acesso à exportação de tabelas completas do Analysis Workspace por padrão: <ul><li>Adição de um novo marcador a [Permissões padrão de administrador de produto](/help/technotes/access-control.md#product-admin-default-permissions).</li><li>Adição de uma observação nos [requisitos mínimos para exportar tabelas completas para a nuvem](/help/analysis-workspace/export/export-cloud.md#minimum-requirements).</li></ul> |
...
| Gerenciar conexões | Artigo [Gerenciar conexões](../connections/manage-connections.md) atualizado, com base no feedback do cliente. |
| Campos derivados | Adição de um resumo da função [limitações](/help/data-views/derived-fields/derived-fields.md#limitations) e uma explicação sobre como determinar o número de [operadores](/help/data-views/derived-fields/derived-fields.md#operators) usados em uma função. |
...
| Medidas de proteção | Adição do artigo listando Customer Journey Analytics [medidas de proteção](../technotes/guardrails.md). |
| Atualizações de conversão de moeda | Esclarecimento de documentação sobre como [configurar a conversão de moeda](/help/data-views/component-settings/format.md). |
...
| **Outubro de 2023** | |
| Uso de campo derivado para definir metas/metas | Adição do artigo [caso de uso](../use-cases/goals-using-derived-fields.md) ilustrando como usar campos derivados para definir metas/metas e gerar relatórios sobre eles. |
...
| Funcionalidade adicional de campos derivados | Atualização da documentação para a nova função [`Lookup`](/help/data-views/derived-fields/derived-fields.md#lookup). |
| **Setembro de 2023** | |
...
| Atualização da documentação do painel Experimentação | Adição de uma seção sobre [interpretação de dimensões não aleatórias](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/panels/experimentation.html#non-randomized). |
...
| Atualização da documentação do Audiences | Nova seção sobre [considerações de latência](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html#latency). |
...
| Outubro de 2022 | Nova seção sobre [funcionalidades data e data-hora em visualizações de dados](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html#date) |
| Outubro de 2022 | Aplicativo móvel: Novo tópico sobre [exibições de detalhes personalizados](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/create-scorecard.html#view-detail-slides). |
...
| Data | Atualizar descrição |
| --- | --- |
| 13 de novembro de 2020 | Novos tópicos sobre [Análise entre canais](/help/stitching/overview.md), que permite o rechaveamento da ID de pessoa de um conjunto de dados e a combinação contínua de vários conjuntos de dados. |
