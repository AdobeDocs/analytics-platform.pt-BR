...
| --- | --- |
| **setembro de 2025** | |
| Interface de uso | Adição de documentação para [Interface de uso](/help/connections/manage-connections.md#usage) atualizada em Conexões. |
| Compilação de conjuntos de dados do Journey Optimizer | [lista documentada de conjuntos de dados do Jornada Otimizer gerados automaticamente](/help/stitching/overview.md#journey-optimizer-datasets) que podem ser usados na compilação. |
| Rótulos de contexto | Foram adicionadas mais informações de plano de fundo sobre o uso e a finalidade de [rótulos de contexto](/help/data-views/component-settings/overview.md#context-labels) em componentes de visualização de dados. |
| **Agosto de 2025** | |
