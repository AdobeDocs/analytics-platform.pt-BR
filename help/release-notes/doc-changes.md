...
| --- | --- |
| **Janeiro de 2026** | |
| Grade de proteção para linhas por ano em uma conexão | Adição de [informações de garantia para limites de transferência de dados](/help/technotes/guardrails.md) sobre o número médio máximo de linhas por ano em uma conexão. |
| Exibir o data center onde seus dados estão armazenados | Adição de [informações sobre os data centers nos quais os dados estão armazenados](/help/technotes/data-centers.md#view-the-data-center-where-your-data-is-stored). |
