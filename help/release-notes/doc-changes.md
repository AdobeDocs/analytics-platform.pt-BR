...
| --- | --- |
| **Agosto de 2025** | |
| Novas funções de campo derivadas | Documentação das novas funções de campo derivadas: [Date Math](/help/data-views/derived-fields/derived-fields.md#date-math), [Depth](/help/data-views/derived-fields/derived-fields.md#depth) e [Typecast](/help/data-views/derived-fields/derived-fields.md#typecast). |
| **Julho de 2025** | |
| Depurador | Novo artigo sobre como habilitar, usar e desabilitar o depurador de projetos no Analysis Workspace. |
| Recomendação de desempenho de visualização de fluxo | Adição de informações declarando que deixar mais de 10 nós expandidos em uma única visualização de fluxo pode afetar o tempo do relatório. |
| Método alternativo para conceder ao Aplicativo Adobe Azure acesso à sua chave | Adição de informações sobre a concessão de permissões por meio do consentimento de autorização ao [configurar chaves gerenciadas pelo cliente](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure) para o Customer Journey Analytics no Azure. |
| **Junho de 2025** | |
