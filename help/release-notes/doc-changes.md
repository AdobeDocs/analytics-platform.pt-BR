...
| --- | --- |
| **Novembro de 2025** | |
| Grade de proteção para linhas por dia em uma conexão | Adição de [informações de garantia para limites de transferência de dados](/help/technotes/guardrails.md) sobre o número médio máximo de linhas por dia em uma conexão. |
| **Outubro de 2025** | |
