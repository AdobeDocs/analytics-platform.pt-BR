...
| --- | --- |
| **Setembro de 2025** | |
| Datas anteriores a 1900 | Adição de uma [observação](/help/connections/create-connection.md#datasets) sobre como as datas anteriores a 1900 são tratadas pela Customer Journey Analytics. |
| Relatório em tempo real | Adição de documentação sobre [relatórios em tempo real](/help/components/real-time/real-time.md) no Customer Journey Analytics. |
