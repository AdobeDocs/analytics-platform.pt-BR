...
|---|---|
| **Fevereiro de 2026** | |
| Gerenciar visualizações de dados | Foram adicionadas informações detalhadas sobre como [gerenciar visualizações de dados](/help/data-views/manage-dataviews.md). |
| Compilação | Atualização da documentação de compilação para refletir as alterações resultantes da [compilação na funcionalidade da interface do usuário de conexões](/help/stitching/use-stitching-ui.md). |
| **Janeiro de 2026** | |
