...
| Modelos de função de campo derivados | Documentação sobre o [modelos de função adicionais para campos derivados](/help/data-views/derived-fields/derived-fields.md#function-templates). |
| **Maio de 2024** | |
