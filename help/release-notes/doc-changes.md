...
| Adição da documentação ausente para dois conjuntos de dados que podem ser incluídos ao integrar o Journey Optimizer | [Dois conjuntos de dados adicionais gerados pelo sistema e que não são relacionados a perfis](/help/integrations/ajo.md#high-throughput-add-on-datasets) são incluídos na conexão quando o complemento de mensagens transacionais de alta taxa de transferência está habilitado para a Organização IMS. |
| Casos de uso de análise de coorte atualizados | Com base no feedback, foram adicionados exemplos do Analysis Workspace para os casos de uso de análise de coorte. |
| **Março de 2026** | |
| Detalhar um painel | Documentação sobre a [área de soltar de um painel](/help/analysis-workspace/c-panels/panels.md#drop-zone) reestruturada para oferecer suporte à nova funcionalidade [detalhar](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel). |
| Nota técnica sobre IDs inválidas (BAVIDs) | Nova [nota técnica sobre IDs inválidas](/help/technotes/badids.md). A nota técnica explica a definição de uma ID inválida, onde as IDs inválidas são usadas na interface do Customer Journey Analytics e como investigar os dados na conexão para IDs inválidas. |
| Redesign da visualização de conjuntos de dados nas Conexões | Atualização da documentação para obter uma experiência aprimorada de visualização de dados ao [adicionar](/help/connections/create-connection.md#add-datasets) ou [editar](/help/connections/create-connection.md#edit-a-dataset) conjuntos de dados em conexões baseadas em pessoa, incluindo a documentação sobre [informações adicionais da visualização de compilação](/help/stitching/use-stitching-ui.md#datasets-preview) para conjuntos de dados habilitados para compilação. |
| Miniaturas e visualizações do Content Analytics | Documentação sobre [miniaturas](/help/content-analytics/report/report.md#thumbnails) e [visualizações](/help/content-analytics/report/report.md#previews) para visualizações adicionais no Content Analytics. |
| **Fevereiro de 2026** | |
| Substituições de cabeçalho | Documentação sobre a [configuração adicional de substituições de cabeçalho](/help/content-analytics/config/guided.md#header-overrides) do Content Analytics. |
| Medidas de proteção de métricas calculadas | Atualização das [medidas de proteção do número máximo de métricas calculadas para uma organização](/help/technotes/guardrails.md#segments-and-calculated-metrics). O máximo agora é de 50.000. |
| Content Analytics independente | Adição de documentação para uma [configuração independente do Content Analytics](/help/content-analytics/config/standalone.md). |
| **Janeiro de 2026** | |
| Projetar um esquema | Adição de informações substanciais e contexto para [Projete o seu esquema para uso com o Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-schema-architect.md). |
...
| --- | --- |
| **Dezembro de 2025** | |
| Consequências das alterações na sandbox | Adição das consequências de uma exclusão ou redefinição de sandbox ao artigo [Consequências da exclusão e da redefinição](/help/technotes/deletion.md). |
| **Novembro de 2025** | |
| Medidas de proteção para linhas por dia em uma conexão | [Medidas de proteção para limites de transferência de dados](/help/technotes/guardrails.md) sobre o número médio máximo de linhas por dia em uma conexão foram adicionadas. |
| **Outubro de 2025** | |
| Gerenciar acesso ao Data Insights Agent | Os [requisitos de permissão e o processo para habilitar visualizações de dados](/help/data-analysis-ai.md#manage-access-to-data-insights-agent) foram atualizados. |
...
| Interface de uso | Documentação adicionada para a [interface de Uso](/help/connections/manage-connections.md#usage) atualizada em Conexões. |
| Compilação de conjuntos de dados do Journey Optimizer | [Lista documentada de conjuntos de dados do Journey Optimizer gerados automaticamente](/help/stitching/overview.md#journey-optimizer-datasets) que podem ser usados na compilação. |
| Rótulos de contexto | Foram adicionadas mais informações básicas sobre o uso e a finalidade de [rótulos de contexto](/help/data-views/component-settings/overview.md#context-labels) em componentes de visualização de dados. |
| **Agosto de 2025** | |
| Nova integração com o Adobe Advertising | Adição de informações sobre a [integração com o Adobe Advertising](/help/integrations/advertising.md). |
| Novas funções de campos derivados | Documentação das novas funções de campos derivados: [Matemática de data](/help/data-views/derived-fields/derived-fields.md#date-math), [Profundidade](/help/data-views/derived-fields/derived-fields.md#depth) e [Conversão de tipo](/help/data-views/derived-fields/derived-fields.md#typecast). |
| **Julho de 2025** | |
...
| Método alternativo para conceder acesso à sua chave ao aplicativo do Adobe Azure | Adição de informações sobre a concessão de permissões por meio do consentimento de autorização ao [configurar chaves gerenciadas pelo cliente](/help/privacy/cmk.md#set-up-customer-managed-keys-for-customer-journey-analytics-on-azure) para o Customer Journey Analytics no Azure. |
| **Junho de 2025** | |
| Novos atalhos | Os novos atalhos de teclado do Analysis Workspace agora permitem [mover painéis do Workspace](/help/analysis-workspace/build-workspace-project/fa-shortcut-keys.md#move-panel-actions) para cima e para baixo em um projeto. |
| **Maio de 2025** | |
| Customer Journey Analytics [!BADGE B2B Edition]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B Edition"} | Documentação preliminar sobre a próxima versão do Customer Journey Analytics B2B Edition, incluindo: <ul><li>novos artigos de [visão geral](/help/getting-started/cja-b2b-edition.md), [conceitos e recursos](/help/getting-started/cja-b2b-concepts-features.md), [guia de início rápido](/help/getting-started/cja-b2b-quick-start-guide.md), [guia de transição](/help/getting-started/cja-b2b-transition.md) e [casos de uso](/help/use-cases/b2b/b2b-edition/use-cases-overview.md) e</li><li>várias atualizações na documentação existente.</li></ul>A documentação, os artigos e os recursos do Customer Journey Analytics B2B Edition são rotulados com um emblema [!BADGE B2B Edition]{type=Informative url="https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B Edition"}. |
...
| Adobe Content Analytics | O [Content Analytics](/help/content-analytics/content-analytics.md) permite investigar de forma rápida e fácil grandes volumes de dados de conteúdo para descobrir tendências, detectar anomalias, identificar a fadiga de conteúdo e obter insights sobre a exposição do conteúdo. |
...
| Casos de uso de exportação de dados atualizados | Adição de exemplos de consulta mais detalhados ao [Serviço de consultas (Destilador de dados) e Conjuntos de dados de exportação](/help/use-cases/data-export/queryservice-export-datasets.md) para ilustrar como aplicar corretamente a atribuição entre sessões usando uma janela de retrospectiva. |
...
| **Outubro de 2023** | |
| Uso de campo derivado para definir metas/objetivos | Adição do artigo de [caso de uso](/help/use-cases/data-views/derived-fields/goals-using-derived-fields.md) ilustrando como usar campos derivados para definir metas/objetivos e gerar relatórios sobre eles. |
...
| Setembro de 2021 | Nova seção sobre as [implicações da mesclagem de conjuntos de relatórios](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-b2c-overview/cja-faq#6.-considerations-when-merging-report-suites-in-cja) no Customer Journey Analytics. |
| **Agosto de 2021** | |
