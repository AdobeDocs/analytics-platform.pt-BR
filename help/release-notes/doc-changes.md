...
| --- | --- |
| **Maio de 2025** | |
| Dimensão Profundidade do evento | Documentação da nova dimensão Profundidade do Evento, como parte dos [componentes padrão necessários](/help/data-views/component-reference.md#required-standard-components) para uma visualização de dados. |
| **Abril de 2025** | |
