...
| **Data Insights Agent no Agent Orchestrator** <br/> Além de estar disponível no painel direito no Customer Journey Analytics, o Data Insights Agent agora está disponível como parte do Agent Orchestrator. Isso significa que agora é possível obter insights que dependem dos dados e recursos do Customer Journey Analytics enquanto você está trabalhando em outros aplicativos da Experience Platform, como no Journey Optimizer.<p>No Customer Journey Analytics, o Data Insights Agent inclui as seguintes melhorias:</p><ul><li>Uma experiência do usuário mais consistente com o Agent Orchestrator</li><li>Parágrafos explicativos resumidos</li><li>Respostas às perguntas sobre o &quot;porquê&quot; por meio da análise da causa principal</li><li>Tabelas embutidas</li><li>E muito mais!&lt;/l></ul><p>(Link para a documentação a seguir).</p> | | Final de maio de 2026 |
