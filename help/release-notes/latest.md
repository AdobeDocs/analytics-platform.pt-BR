...
| **Classificar componentes no Analysis Workspace** | <p>Uma nova opção Classificar está disponível ao visualizar componentes no painel esquerdo ou no Dicionário de dados no Analysis Workspace. Você pode classificar componentes por Recomendado (os mais usados), Alfabético ou Categórico (tipo).</p><p>Anteriormente, você só podia pesquisar ou filtrar componentes. [Saiba mais](/help/components/overview.md)</p> | N/D | 17 de maio de 2023 |
