...
# Customer Journey Analytics atual notas de versão (janeiro de 2026)

**Última atualização**: quinta-feira, 14 de janeiro de 2026

Esses notas de versão abrangem o período de lançamento de janeiro de 2026. As versões do Adobe Customer Journey Analytics operam em um [modelo de entrega contínua](releases.md) que permite uma abordagem escalável e em fases para a implantação de recursos. Sendo assim, essas notas de versão são atualizadas várias vezes por mês. Verifique-as regularmente.

## Recursos novos ou atualizados

| Recurso | Descrição | [Início da implantação](releases.md) | [Disponibilidade geral](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Analise públicos-alvo a partir de conjuntos de dados de Experience Platform de perfil no Customer Journey Analytics** | Agora é possível assimilar público-alvo dados associação dos conjuntos de dados do Experience Platform Profile em uma conexão Customer Journey Analytics. Audiences ficam disponíveis como novas dimensões para uso no Analysis Workspace.<p>Isso é possibilitado por meio de um novo recurso no Customer Journey Analytics para assimilar mapas de objetos XDM, o que permite assimilar AudienceIDs de perfil.</p><p>Anteriormente, apenas mapas XDM simples podiam ser assimilados em Customer Journey Analytics.</p><p>Além de poder adicionar público-alvo dados como dimensões a qualquer projeto em Analysis Workspace, também estão disponíveis os novos Área de trabalho modelos a seguir:</p><ul><li>Visão geral do Analytics público-alvo</li><li>Visão geral da política de consentimento</li><p><!--For more information, see "Audience analysis overview" (https://experienceleague.corp.adobe.com/docs/analytics-platform/using/cja-dataviews/audience-analysis/audience-analysis-overview.html).-->(Link para a documentação a seguir).</p> | 22 de outubro de 2025 | sexta-feira, 22 de janeiro de 2026 |
| **Narração de dados: gere apresentações de slides a partir de relatórios do Workspace** | Agora você pode gerar automaticamente uma apresentação de slides (no formato .pptx) com base em um relatório do Analysis Workspace. O Workspace detecta as principais informações do seu relatório e as converte em slides prontos para serem apresentados às partes interessadas.<p>Esse recurso reduz o tempo e o esforço necessários para revelar descobertas, criar narrativas executivas e comunicar o impacto nos negócios.</p><p>(Link da documentação em breve).<!--For more information, see [Data storytelling: Generate slide presentations from Workspace reports](/help/analysis-workspace/curate-share/generate-slides.md).--></p> | 22 de outubro de 2025 | quinta-feira, 28 de janeiro de 2026 |
| **Incluir várias colunas dimensão em uma tabela de forma livre** | Agora é possível incluir até 5 colunas dimensão em uma tabela de forma livre, permitindo que você visualização vários dimensão itens lado a lado. Cada linha de dimensão itens se comporta curtir um único item dimensão concatenado.<p>É possível aplicar filtros, classificação, detalhamentos e muito mais a tabelas de forma livre com várias colunas dimensão para criar uma análise mais profunda e personalizada.</p><p>Anteriormente, era possível incluir apenas 1 dimensão coluna em uma tabela de forma livre.</p><p><!-- For more information, see [Include multiple dimension columns in a freeform table](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md).--> (Link para a documentação a seguir).</p> | quinta-feira, 28 de janeiro de 2026 | quinta-feira, 18 de fevereiro de 2026 |
| **Classificar tabelas por várias colunas** | Agora é possível classificar os dados de uma tabela de forma livre por várias colunas em Analysis Workspace, sejam elas dimensões ou métricas.<p>Quando você classifica dados para várias colunas, os dados são classificados de acordo com a prioridade atribuída a cada coluna. A numeração de prioridade é exibida ao lado do ícone de classificação.</p><p>(Link da documentação em breve).<!-- For more information, see "Filter and sort freeform tables". (need to move info to this article from "Include multiple dimension columns in a freeform table") --></p> | quinta-feira, 28 de janeiro de 2026 | quinta-feira, 18 de fevereiro de 2026 |
| **Combinar fontes de dados de várias organizações IMS** | Agora você pode usar o Analytics Origem Connector para combinar várias fontes de dados de várias organizações IMS. Isso permite que as organzações tenham uma visualização combinada dos dados de seus clientes, mesmo quando os dados do cliente são espalhados por várias organizações IMS. <p>**Observação:** essa configuração está disponível somente enviando uma solicitação para o Atendimento ao cliente Adobe Systems.</p>  <p>(Link para a documentação a seguir).</p> |  | sábado, 30 de janeiro de 2026 |
| **Compilação em conexões** | O processo de costura em Customer Journey Analytics agora é mais simples. Em vez de duplicar um conjunto de dados e aplicar a compilação no conjunto de dados duplicado, a compilação agora é feita na assimilação de dados do Customer Journey Analytics, o que remove o requisito de conjuntos de dados e esquemas duplicados. <p>Além disso, agora [você pode iniciar a costura através de uma interface](/help/stitching/use-stitching-ui.md) atualizada do Connections, em vez de ter que solicitação costurar através Adobe Systems atendimento ao cliente.</p><p> *As datas de lançamentos comunicadas anteriormente foram adiadas devido aos esforços adicionais necessários e à temporada de férias. Uma implantação em fases está planejada para garantir estabilidade e minimizar interrupções durante a temporada de feriados.*</p> | 28 de outubro de 2025 | sábado, 30 de janeiro de 2026 |
...
**guia análise**: AN-421274
**Exportações**:
**Exibições** de dados: AN-421891, AN-404627
**Implementação**:
