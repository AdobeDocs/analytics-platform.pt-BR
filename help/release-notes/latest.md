...
| **Campos Derivados - Função Deduplicate** | A função Desduplicar em Campos Derivados ajuda a impedir a contagem de um valor várias vezes.<p>(Link da documentação em breve)</p> |  | quarta-feira, 16 de julho de 2024 |
