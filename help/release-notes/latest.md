...
**Última atualização**: sexta-feira, 8 de maio de 2025
...
| ----------- | ---------- | ------- | ---- |
| **Dimensão de Profundidade do Evento** | Uma nova dimensão Profundidade do evento é adicionada à lista de [dimensões padrão](/help/components/dimensions/overview.md#standard-dimensions) para uma visualização de dados. |  | sexta-feira, 8 de maio de 2025 |
| **Aumento em limites completos de exportação de tabela** | O número de colunas que os clientes podem usar com a exportação de tabela completa aumentou de 5 dimensões e 5 métricas para 10 dimensões e 10 métricas. Esse aumento se aplica a todos os níveis do Customer Journey Analytics. Não há alteração nos direitos para o número de linhas que podem ser exportadas. |  | 30 de abril de 2025 |
