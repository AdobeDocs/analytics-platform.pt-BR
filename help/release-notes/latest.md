...
| **Uso do Report Builder incluído na coluna “Usado em” no Gerenciador de métricas calculadas e no Gerenciador de filtros** | Ao visualizar a coluna **Usado em** no Gerenciador de métricas calculadas ou no Gerenciador de filtros, os dados de uso agora estão disponíveis para o Report Builder.<p>Anteriormente, os dados de uso no Gerenciador de filtros estavam disponíveis apenas para Alertas, Projetos, Projetos programados e Métricas calculadas, enquanto os dados de uso no Gerenciador de métricas calculadas estavam disponíveis apenas para Alertas, Projetos e Projetos programados.</p> |  | Final de março ou início de abril |
