...
| **Criar métricas e dimensões com base em campos de mapa definidos pelo usuário do esquema da Platform** | Os campos de mapa definidos pelo usuário no esquema da Experience Platform agora estão disponíveis para uso no Customer Journey Analytics.<p>É possível usar os seguintes campos de mapa ao criar métricas e dimensões no Customer Journey Analytics:</p><ul><li>String para String</li><li>String para Inteiro</li></ul><p>Para obter mais informações, consulte [Configurações do componente](/help/data-views/component-settings/overview.md).</p><p>Para obter mais informações sobre campos de mapa na Experience Platform, consulte [Definir campos de mapa na interface](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/ui/fields/map).</p> |  | Final de agosto de 2025 |
...
| **Relatório em tempo real** | O relatório em tempo real no Customer Journey Analytics exibe e atualiza dados e visualizações em um ou mais painéis no Analysis Workspace em tempo real.<br/><br/>(Link de documentação a seguir.) | | 18 de setembro de 2025 (originalmente planejado para ser lançado em 15 de agosto de 2025) |
