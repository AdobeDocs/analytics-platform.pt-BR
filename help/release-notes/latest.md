...
| ----------- | ---------- | ------- | ---- |
| **Dimensão de Profundidade do Evento** | Uma nova dimensão Profundidade do Evento é adicionada à lista de [componentes padrão necessários](/help/data-views/component-reference.md#required-standard-components) para uma visualização de dados. |  | sexta-feira, 8 de maio de 2025 |
