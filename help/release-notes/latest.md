...
**Última atualização**: sábado, 1 de março de 2024
...
| **Métricas de uso** | A interface de métricas de uso mostra o uso de linhas assimiladas e relatáveis em todas as conexões. Essa interface permite determinar se o uso do Customer Journey Analytics está em conformidade com o que foi acordado contratualmente. | 20 de fevereiro de 2024 | quarta-feira, 12 de março de 2024 |
| **Adobe Product Analytics: compartilhar com qualquer pessoa** | Permite compartilhar um link de somente leitura para projetos do Adobe Product Analytics com pessoas que não têm acesso ao Product Analytics. |  | quarta-feira, 5 de março de 2024 |
