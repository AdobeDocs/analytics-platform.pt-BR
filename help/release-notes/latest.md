...
| **Aprimoramento de permissões para componentes exclusivos de projetos do [!UICONTROL espaço de trabalho]** | Anteriormente, se o usuário A compartilhasse um projeto com o usuário B e concedesse acesso de edição ao projeto, o usuário B poderia editar o projeto. No entanto, o usuário B não poderia editar [!UICONTROL segmentos rápidos] incorporados no projeto. Essa limitação foi removida: o usuário B agora pode editar [!UICONTROL segmentos rápidos] e outros componentes exclusivos incorporados no projeto compartilhado. |  | 17 de abril de 2024 |
