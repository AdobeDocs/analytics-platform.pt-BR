...
| **Detecção de bot da Experience Edge** | [Detecção de bot](https://experienceleague.adobe.com/docs/experience-platform/datastreams/bot-detection.html) O permite identificar eventos gerados pelo SDK da Web, SDK móvel e API do servidor como sendo gerados por spiders e bots conhecidos. | | terça-feira, 29 de abril de 2024 |
