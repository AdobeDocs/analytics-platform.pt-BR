...
| **Configurações do administrador para controlar as contas e os locais usados ao exportar relatórios para a nuvem** | Uma nova guia [&quot;Configurações do administrador&quot; no Gerenciador de locais](/help/components/exports/manage-export-locations.md#configure-company-wide-settings-administrators-only) fornece aos administradores controle sobre se os usuários podem criar e editar contas e locais.<p>Essas configurações se aplicam quando os usuários [configuram contas de exportação em nuvem](/help/components/exports/cloud-export-accounts.md) e [configuram locais de exportação em nuvem](/help/components/exports/cloud-export-locations.md).</p><p>Os administradores também podem limitar os tipos de contas que os usuários podem criar e usar. Os tipos de conta incluem Google Cloud Platform, Azure RBAC, Amazon S3, AEP Data Landing Zone, Snowflake e assim por diante.</p><p>Anteriormente, qualquer usuário podia criar, editar e usar contas e locais para qualquer tipo de conta.</p> | sexta-feira, 11 de julho de 2024 | sábado, 19 de julho de 2024 |
...
| **Campos Derivados - Função Deduplicate** | A função Desduplicar em Campos Derivados ajuda a impedir a contagem de um valor várias vezes.<p>[Saiba mais](/help/data-views/derived-fields/derived-fields.md#deduplicate)</p> |  | quinta-feira, 17 de julho de 2024 |
