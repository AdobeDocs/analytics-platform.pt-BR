...
| Suporte a horário de verão para relatórios | Todos os dados no Customer Journey Analytics são armazenados em UTC (não com um fuso horário específico). [!UICONTROL Visualizações de dados] O no Customer Journey Analytics agora pode transferir dados para contabilizar o aumento ou a diminuição de 1 hora com base no horário de verão. [Saiba mais](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/create-dataview.html?lang=pt-BR#calendar) | sexta-feira, 16 de setembro de 2021 |
...
| Recurso | [Disponibilidade geral](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=pt-BR) - Data do Target | Descrição |
| ----------- | ---------- | ----- |
| Suporte para [!UICONTROL painéis do Adobe Analytics] | 25 de março de 2021 | [!UICONTROL Customer Journey Analytics] O agora é compatível com o [!UICONTROL Criador de scorecard dos painéis do Adobe Analytics] e o aplicativo móvel. Isso permite que executivos e usuários empresariais vejam seus KPIs entre canais com base em dados de Customer Journey Analytics, usando o mesmo aplicativo que já podem estar usando para o Adobe Analytics. |
