...
| **Compatibilidade com esquemas ad hoc e relacionais** | [Esquemas ad hoc](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/tutorials/ad-hoc) e [relacionais](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/schema/relational) são usados em fluxos de trabalho de assimilação de dados e de espelhamento de dados da Experience Platform. |  | 23 de setembro de 2025 (lançamento planejado originalmente para 28 de agosto de 2025) |
...
| **Projetos baixados como PDFs são enviados para a sua estação de trabalho** | Ao baixar um projeto como PDF, ele é enviado para a pasta de downloads na sua estação de trabalho. Anteriormente, o download de um projeto como PDF iniciava o PDF em uma nova guia do navegador com um URL exclusivo. (Link da documentação a seguir) | | 25 de agosto de 2025 |
...
**B2B**: AN-376028
**Extensão BI para Tableau**: AN-377488
...
**tela de Jornada**: AN-375865; AN-378011
...
**tela de Jornada**: AN-373319
**Report Builder**: AN-369786
**Relatórios**: AN-377326; AN-378051
**Gerente de atividades de relatórios**: AN-377148
...
**Visualizações de dados**: AN-369504
**Filtros**: AN-369037
