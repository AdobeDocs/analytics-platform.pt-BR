...
1. Selecione uma categoria para exibir os modelos contidos nela.
   ...
   * **[!UICONTROL Web]** > **[[!UICONTROL Compromisso]](#web-engagement)**
   ...
   * **[!UICONTROL Dispositivo móvel]** > **[[!UICONTROL Aplicativo móvel]](#mobile-mobile-app)**
...
>abstract="**Isso pode ajudar você** a saber como seu conteúdo está se saindo em um nível granular. É possível analisar o desempenho de ativos individuais ou atributos específicos. O Content Analytics usa IA para gerar atributos automaticamente e marcar seu conteúdo com eles. [Mais Informações](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/content-analytics/content-analytics).<br/>**Com base no que aprender, você poderá** fazer uma série de coisas, como promover ativos de alto desempenho na sua página inicial, personalizar conteúdo para segmentos específicos a fim de incluir atributos de alto desempenho ou eliminar conteúdo que está próximo de se tornar obsoleto."



>[!CONTEXTUALHELP]
>id="template--content-analytics-paid-media"
>title="Saiba quais conteúdos de mídia paga e atributos de conteúdo apresentam o melhor desempenho."
>abstract="**Isso pode ajudar você a** saber como seu conteúdo de mídia paga está apresentando desempenho em um nível granular. Você pode revisar o alcance, o engajamento, os gastos e a eficiência da mídia paga em redes, contas, campanhas, experiências e ativos. As métricas e dimensões neste painel permanecem intencionalmente na granularidade do resumo de ativos de mídia paga. Não combine conjuntos de dados de resumo com dados do evento.  [Mais Informações](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/content-analytics/content-analytics).<br/>**Com base no que você aprender, talvez** você queira fazer várias coisas, como mudar o foco de como gasta dinheiro nos seus canais de mídia paga, gastar mais dinheiro em campanhas com baixo desempenho ou gastar mais dinheiro em campanhas com ativos de alto desempenho."
...
| **Content Analytics** | Saiba qual conteúdo e atributos de conteúdo apresentam melhor desempenho.<p>**Isso pode ajudar você** a saber como seu conteúdo está se saindo em um nível granular. É possível analisar o desempenho de ativos individuais ou atributos específicos. O Content Analytics usa IA para gerar atributos automaticamente e marcar seu conteúdo com eles. Consulte [Content Analytics](/help/content-analytics/content-analytics.md) para mais informações.</p><p>**Com base no que aprender, você poderá** fazer uma série de coisas, como promover ativos de alto desempenho na sua página inicial, personalizar conteúdo para segmentos específicos a fim de incluir atributos de alto desempenho ou eliminar conteúdo que está próximo de se tornar obsoleto.</p> |
| **Content Analytics de mídia paga** | Saiba quais conteúdos de mídia paga e atributos de conteúdo apresentam o melhor desempenho.<p>**Isso pode ajudar você a** saber como seu conteúdo de mídia paga está apresentando desempenho em um nível granular. Você pode revisar o alcance, o engajamento, os gastos e a eficiência da mídia paga em redes, contas, campanhas, experiências e ativos. As métricas e dimensões neste painel permanecem intencionalmente na granularidade do resumo de ativos de mídia paga. Não combine conjuntos de dados de resumo com dados do evento. Consulte [Content Analytics](/help/content-analytics/content-analytics.md) para mais informações.<p/><p>**Com base no que você aprender, talvez** você queira fazer várias coisas, como mudar o foco de como gasta dinheiro nos seus canais de mídia paga, gastar mais dinheiro em campanhas com baixo desempenho ou gastar mais dinheiro em campanhas com ativos de alto desempenho.</p> |
...
>abstract="**Isso pode ajudar você** a entender melhor a eficácia dos emails que você cria e envia usando o Adobe Journey Optimizer.<br/>**Com base no que aprender, você poderá** realizar várias ações, como ajustar a sua estratégia de emails para uma determinada campanha de emails."
