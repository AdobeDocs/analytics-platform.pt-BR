...
1. Siga um destes procedimentos:
   ...
   * Visualize o modelo.
   * Arraste um ou mais filtros até a zona de destino “Filtro” na parte superior. Por exemplo, arraste o filtro [!UICONTROL **Clientes móveis**] e visualize os resultados.
...
| **Ações do aplicativo móvel** | Confira as ações que as pessoas estão realizando no aplicativo móvel. <p>**Isso pode ajudar** a entender melhor como as pessoas estão usando o seu aplicativo e o valor que estão obtendo com ele.</p><p>**Com base no que aprendeu, você poderá** fazer várias coisas, como desenvolver recursos que complementem ou aprimorem os mais populares.</p><p>Este modelo usa as métricas “Eventos”, “Sessões”, “Pessoas” e “Alteração percentual”. |
