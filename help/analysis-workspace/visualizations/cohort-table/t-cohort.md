...
1. No [Construtor de filtros](/help/components/filters/manage-filters.md), faça mais edições no filtro e clique em **[!UICONTROL Salvar]**.

   O filtro salvo está disponível para uso no painel [!UICONTROL Filtro] em [!UICONTROL Analysis Workspace].
