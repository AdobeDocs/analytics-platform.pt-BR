...
1. No [Construtor de filtro](https://docs.adobe.com/content/help/pt-BR/analytics/components/segmentation/segmentation-workflow/seg-build.html), edite ainda mais o segmento e clique em **[!UICONTROL Salvar]**.
