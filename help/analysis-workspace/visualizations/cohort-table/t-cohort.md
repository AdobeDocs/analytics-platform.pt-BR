...
1. Na [Construtor de filtro](https://docs.adobe.com/content/help/pt-BR/analytics/components/segmentation/segmentation-workflow/seg-build.html)edite o segmento e clique em **[!UICONTROL Salvar]**.
