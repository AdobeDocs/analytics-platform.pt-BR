...
1. (Opcional) Crie um filtro a partir de uma seleção.
   ...
   Selecione as células (contíguas ou não contíguas) e clique com o botão direito do mouse em > **[!UICONTROL Criar filtro da seleção]**.

1. No [Construtor de filtro](/help/components/filters/manage-filters.md), edite ainda mais o segmento e clique em **[!UICONTROL Salvar]**.
