...
1. (Opcional) Crie um filtro a partir de uma seleção.
   ...
   Selecione as células (contíguas ou não contíguas) e clique com o botão direito do mouse em > **[!UICONTROL Criar filtro a partir da seleção]**.

1. No [Construtor de filtros](/help/components/filters/manage-filters.md), edite ainda mais o filtro e clique em **[!UICONTROL Salvar]**.

   O filtro salvo está disponível para uso na variável [!UICONTROL Filtro] no painel [!UICONTROL Analysis Workspace].
