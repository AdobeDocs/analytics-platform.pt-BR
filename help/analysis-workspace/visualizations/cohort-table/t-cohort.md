...
Como outras visualizações no Analysis Workspace, é possível baixar uma visualização de coorte como um arquivo CSV ou PDF. Para obter mais informações, consulte [Baixar arquivos PDF ou CSV](/help/analysis-workspace/curate-share/download-send.md).