...
*Este artigo documenta a visualização Treemap em **Customer Journey Analytics**.<br/>Consulte [Treemap](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/treemap) para a versão **Adobe Analytics**deste artigo.*
