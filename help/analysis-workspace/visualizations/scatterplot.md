...
*Este artigo documenta a visualização Dispersão em **Customer Journey Analytics**.<br/>Consulte [Dispersão](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/scatterplot) para a versão **Adobe Analytics**deste artigo.*
