...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Compartilhamento de projetos no Analysis Workspace](https://video.tv.adobe.com/v/40035/?captions=por_br&quality=12&learn=on){target="_blank"} para assistir a um vídeo de demonstração.
...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Compartilhar com qualquer pessoa](https://video.tv.adobe.com/v/3452457/?captions=por_br&quality=12&learn=on){target="_blank"} para assistir a um vídeo de demonstração.
...
1. Escolha se deseja habilitar a seguinte opção de segurança (esta opção pode ser controlada pelo administrador do Customer Journey Analytics):
   ...
   * **[!UICONTROL Exigir autenticação da Experience Cloud]:**
      ...
      * Se essa opção estiver habilitada e não puder ser desabilitada, isso significa que o administrador do Customer Journey Analytics exige a autenticação da Experience Cloud para qualquer pessoa que acesse projetos do Analysis Workspace. Esse é sempre o caso de organizações que adquirem uma licença do Healthcare Shield.
...
Consulte ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Compartilhar componentes integrados no Analysis Workspace](https://video.tv.adobe.com/v/30805/?captions=por_br&quality=12&learn=on){target="_blank"} para assistir a um vídeo de demonstração.
