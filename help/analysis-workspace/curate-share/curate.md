...
>[!NOTE]
> Os perfis de produto são o principal mecanismo que controla os componentes que um usuário pode ver. Eles são gerenciados por meio da Adobe Experience Cloud Admin Console. A Preparação é um filtro secundário.
