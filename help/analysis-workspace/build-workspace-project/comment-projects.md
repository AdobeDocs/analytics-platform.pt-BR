...
Os comentários no Analysis Workspace permitem compartilhar insights e fazer perguntas no contexto de um projeto do Analysis Workspace. Isso pode simplificar as conversas sobre os dados, mantendo-as dentro do contexto dos dados em questão.
...
1. Com o projeto aberto no Analysis Workspace, selecione o ícone da área de comentários ![Ícone da área de comentários](/help/assets/icons/Comment.svg) no painel direito do Analysis Workspace. <!-- add screen shot -->
