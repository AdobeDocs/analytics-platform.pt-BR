...
| Elemento | Descrição |
|---|---|
| [Criar novo projeto](/help/analysis-workspace/home.md) | Clique neste link para iniciar um novo projeto do zero ou em um [modelo](/help/analysis-workspace/build-workspace-project/starter-projects.md) criado para você. |
...
| Tipo | Indica se é um projeto do Workspace ou um [Scorecard móvel](/help/mobile-app/home.md). |
...
| [Paleta de cores do projeto](/help/analysis-workspace/build-workspace-project/color-palettes.md) | É possível alterar a paleta de cores categórica usada no Workspace escolhendo entre paletas predefinidas que foram otimizadas para a cegueira de cores ou especificando a paleta personalizada. Esse recurso afeta muitas coisas no Workspace, incluindo a maioria das visualizações. |
...
Painéis são úteis quando você deseja organizar seus projetos de acordo com períodos de tempo, visualizações de dados ou caso de uso de análise. O painel principal terá uma borda azul ao seu redor e determina quais componentes estão disponíveis no painel esquerdo.
...
| Ação | Descrição |
|---|---|
| Adicionar | Crie um novo projeto do zero ou inicie com um [modelo](/help/analysis-workspace/build-workspace-project/starter-projects.md). |
