...
Consulte o artigo [Como lidar com Nenhum valor](./no-value.md) para obter detalhes sobre como lidar com vários cenários de caso de uso de **[!UICONTROL Nenhum valor]**.
