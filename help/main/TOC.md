...
+ Customer Journey Analytics e Adobe Analytics {#compare-aa-cja}
   ...
   + Migrar para o Customer Journey Analytics {#migrate-to-cja}
      + [Introdução](/help/getting-started/cja-migration/cja-migration-getstarted.md)
      + [Escolha um método de migração](/help/getting-started/cja-migration/cja-migration-method.md)
...
+ Casos de uso {#cja-usecases}
   ...
   + Dados do Adobe Analytics {#aa-data}
      ...
      + [Emulação de feeds de dados](../use-cases/emulating-data-feeds.md)
...
+ Administração {#cja-admin}
   + [Medidas de proteção](../admin/guardrails.md)
   ...
   + [Endereços IP](../admin/ip-addresses.md)
...
+ Notas técnicas {#technotes}
   + [data centers Customer Journey Analytics](../technotes/cja-datacenters.md)
