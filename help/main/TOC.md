...
+ Introdução {#cja-overview}
  + Customer Journey Analytics {#cja-b2c-overview}
    ...
    + {hide-from-toc}[Comparação de produtos do Analytics](/help/getting-started/analytics-product-comparison.md)
...
+ Atualizar e comparar {#compare-aa-cja}
  ...
  + Comparar com o Adobe Analytics {#cja-aa-comparison}
    ...
    + [Mapeamento de dados entre IMS](../getting-started/aa-vs-cja/mapping-data-ims-orgs.md)
  ...
  + Transição do Google Analytics 4 {#ga-to-cja}
    + [Visão geral](/help/getting-started/ga-to-cja/home.md)
    + [Modelo de dados](/help/getting-started/ga-to-cja/data-model.md)
    + [Equivalentes do relatório](/help/getting-started/ga-to-cja/reports.md)
    + [Diferenças de dados](/help/getting-started/ga-to-cja/compare-data.md)
...
+ Espelho de dados {#cja-data-mirror}
  ...
  + [Guia de início rápido](/help/data-mirror/relational.md)
  + [Considerações](/help/data-mirror/considerations.md)
...
+ Conexões {#cja-connections}
  ...
  + Relatórios e filtragem de consentimento {#consent-reporting-filtering}
    + [Visão geral](/help/connections/consent-reporting-filtering/consent-overview.md)
    + [Configurar](/help/connections/consent-reporting-filtering/consent-configure.md)
    + [Gerenciar](/help/connections/consent-reporting-filtering/consent-manage.md)
    + [Analisar](/help/connections/consent-reporting-filtering/consent-analyze.md)
...
+ Visualizações de dados {#cja-dataviews}
  ...
  + Configurações de componente {#component-settings}
    ...
    + {hide-from-toc}[Escopo](/help/data-views/component-settings/scope.md)
...
+ Projetos do Workspace {#cja-workspace}
  ...
  + Visualizações {#visualizations}
    ...
    + Tabela de forma livre {#freeform-table}
      ...
      + [Exibir dados de tendências](/help/analysis-workspace/visualizations/freeform-table/freeform-table-trended-data.md)
      + [Incluir várias dimensões](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
...
+ Componentes {#cja-components}
  ...
  + Segmentos {#segments}
    ...
    + [Análise de sub-evento](/help/components/segments/sub-event.md)
...
+ Relatório de população total {#tpr}
  ...
  + {hide-from-toc}[Pesquisas compartilhadas](/help/tpr/shared-lookups.md)
...
+ Casos de uso {#cja-usecases}
  ...
  + Dados complexos {#complex-data}
    ...
    + [Sem tratamento de valor](../use-cases/data-views/no-value.md)
  ...
  + Exportação de dados {#data-export}
    ...
    + [Exportação do Workspace](../use-cases/data-export/workspace-export.md)
    + [Report Builder](../use-cases/data-export/report-builder.md)
    + [API de relatórios](../use-cases/data-export/reporting-api.md)
  ...
  + Visualizações de dados {#data-views}
    ...
    + Extensão BI {#bi-extension}
      + [Casos de uso](/help/use-cases/data-views/bi-extension-usecases.md)
      + [Conectar e listar visualizações de dados](/help/use-cases/data-views/bi-extension/connect-and-validate.md)
      + [Tendência diária](/help/use-cases/data-views/bi-extension/daily-trend.md)
      + [Tendência horária](/help/use-cases/data-views/bi-extension/hourly-trend.md)
      + [Tendência mensal](/help/use-cases/data-views/bi-extension/monthly-trend.md)
      + [Dimensão única classificada](/help/use-cases/data-views/bi-extension/single-dimension-ranked.md)
      + [Várias dimensões classificadas](/help/use-cases/data-views/bi-extension/multiple-dimension-ranked.md)
      + [Contar valores de dimensão distintos](/help/use-cases/data-views/bi-extension/count-distinct-dimension-values.md)
      + [Usar nomes de intervalo de datas para filtrar](/help/use-cases/data-views/bi-extension/use-date-range-names-to-filter.md)
      + [Usar nomes de segmento para segmentar](/help/use-cases/data-views/bi-extension/use-segment-names-to-segment.md)
      + [Usar valores de dimensão para segmentar](/help/use-cases/data-views/bi-extension/use-dimension-values-to-segment.md)
      + [Classificar](/help/use-cases/data-views/bi-extension/sort.md)
      + [Limites](/help/use-cases/data-views/bi-extension/limits.md)
      + [Transformações](/help/use-cases/data-views/bi-extension/transformations.md)
      + [Visualizações](/help/use-cases/data-views/bi-extension/visualizations.md)
      + [Avisos](/help/use-cases/data-views/bi-extension/caveats.md)

    + Campos derivados {#derived-fields}
      + [Diretrizes de campos derivados](/help/use-cases/data-views/derived-fields/guidelines.md)
      + [Relatório sobre tráfego gerado por LLM e IA](/help/use-cases/data-views/derived-fields/ai-traffic.md)
      + [Relatório de metas](/help/use-cases/data-views/derived-fields/goals-using-derived-fields.md)
...
+ Notas técnicas {#technotes}
  ...
  + [IDs inválidas](/help/technotes/badids.md)
  + [Navegador e idioma](/help/technotes/browser-language.md)
