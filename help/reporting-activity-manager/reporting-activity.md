...
1. No Customer Journey Analytics, vá para **[!UICONTROL Ferramentas]** > **[!UICONTROL Gerente de atividades de relatórios]**.
   ...
   ![Atividade de relatório mostrando a fila de relatórios](assets/reporting-activity1.png)
...
| [!UICONTROL **Projeto**] | Nomes de projeto do Workspace salvos, IDs de relatório da API e assim por diante. (Os metadados podem variar em vários aplicativos.)<p>**Observação:** se o valor desta coluna for [!UICONTROL **Desconhecido**], isso significa que o projeto não foi salvo ou que os metadados da solicitação não estão disponíveis para o usuário.</p> |
