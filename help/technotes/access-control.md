...
| [!UICONTROL Ferramentas de relatório] | [!UICONTROL Visualização de público-alvo] | Permitir que os usuários visualizem [públicos-alvo](/help/components/audiences/audiences-overview.md). |
...
| [!UICONTROL Ferramentas de relatório] | [!UICONTROL Narrativa de dados] | Permitir que os usuários [gerem apresentações de slides com base em projetos do Workspace.](/help/analysis-workspace/curate-share/generate-slides.md) |
