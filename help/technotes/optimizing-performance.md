...
| [!UICONTROL **Limites mensais**] | O número de meses incluídos em uma solicitação. Mais limites mensais aumentam a complexidade da solicitação. A orientação é 6 ou menos. | Se as solicitações estiverem lentas aqui, pode ser porque os limites do mês no seu projeto são muito grandes. Tente reduzir o número de meses. |
