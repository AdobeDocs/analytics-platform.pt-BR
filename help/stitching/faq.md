...
* A repetição diária é executada por volta das 3:00 (fuso horário do cliente), de modo que os dados são atualizados nos relatórios do Customer Journey Analytics pela manhã.

>[!IMPORTANT]
>
>O dia da repetição semanal e a hora da repetição diária não podem ser alterados por meio de uma solicitação personalizada.
>
